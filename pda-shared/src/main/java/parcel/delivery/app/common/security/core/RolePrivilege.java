...
public enum RolePrivilege implements GrantedAuthority {
    BASIC, CREATE_COURIER_USER, VIEW_ORDERS, CREATE_ORDER, CHANGE_ORDER_STATUS, CANCEL_ORDER, CHANGE_DESTINATION, VIEW_DELIVERY_DETAILS, ASSIGN_COURIER, VIEW_COURIERS;

...
import static parcel.delivery.app.common.security.core.RolePrivilege.ASSIGN_COURIERS;
...
public enum UserType implements GrantedAuthority {
    ...
    ADMIN(BASIC, CREATE_COURIER_USER, CHANGE_ORDER_STATUS, VIEW_ORDERS, ASSIGN_COURIERS),
